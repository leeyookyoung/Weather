...
fun getTransitionValue(infiniteTransition: InfiniteTransition, type: TransitionType): Float {
    ...
    return when (type) {
        ...
        TransitionType.UP_DOWN1 -> transition(initialValue = 10f, targetValue = 35f, durationMillis = 1000, easing = LinearOutSlowInEasing, repeatMode = RepeatMode.Restart)
        TransitionType.UP_DOWN2 -> transition(initialValue = 15f, targetValue = 37f, durationMillis = 1000, easing = LinearEasing, repeatMode = RepeatMode.Restart)
        TransitionType.UP_DOWN3 -> transition(initialValue = 18f, targetValue = 39f, durationMillis = 1000, easing = FastOutSlowInEasing, repeatMode = RepeatMode.Restart)
        TransitionType.UP_DOWN4 -> transition(initialValue = 8f, targetValue = 35f, durationMillis = 1000, easing = LinearEasing, repeatMode = RepeatMode.Restart)
